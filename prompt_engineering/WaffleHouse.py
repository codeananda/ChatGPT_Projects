...
Start chatting with the WaffleBot below to find out what you can order, how much it costs and how to pay.'''
st.markdown(intro)
...
You wait to collect the entire order, the summarize it and check for a final time if the \
...
initial_state = [
    ...
    {'role': 'assistant', 'content': 'Hello, welcome to Waffle House! What can I get for you today?'}
]
...
message('Welcome to the Waffle House! What can I get for you?', avatar_style=wh_avatar,)
